...
usage() { echo "Usage: $0 [-m <masterName>] [-k <nfsServerName>] [-x <nasName>] [-y <nasDevice>] [-z <nasMountPoint>] [-f <dnsServerName>] [-g <dnsServerIP>] [-s <pbspro>] [-q <queuename>] [-S <beegfs, nfsonmaster, otherstorage>] [-n <ganglia>] [-c <postInstallCommand>]" 1>&2; exit 1; }
